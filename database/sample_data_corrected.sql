-- TeamTango Sample Data Generation Script (Corrected)
...
INSERT IGNORE INTO sports (sport_id, sport_name, description) VALUES
...
INSERT INTO venues (venue_name, location, address, city, contact_number, owner_id, price_per_hour, sport_id) VALUES
...
INSERT INTO timeslots (venue_id, date, start_time, end_time, is_available) VALUES
-- Football venues (1-5)
...
INSERT INTO teammembers (team_id, user_id, joined_date) VALUES
...
INSERT INTO bookings (user_id, venue_id, date, start_time, end_time, total_amount, booking_status) VALUES
...
(5, 2, '2025-01-15', '18:00:00', '19:00:00', 85.00, 'confirmed'),
(6, 7, '2025-01-19', '08:00:00', '11:00:00', 300.00, 'confirmed'),
(7, 11, '2025-01-15', '18:00:00', '19:00:00', 60.00, 'confirmed'),
(8, 3, '2025-01-16', '19:00:00', '20:00:00', 70.00, 'pending'),
(9, 8, '2025-01-20', '15:00:00', '18:00:00', 330.00, 'confirmed'),
(10, 12, '2025-01-16', '19:00:00', '20:00:00', 65.00, 'confirmed'),
(11, 13, '2025-01-17', '20:00:00', '21:00:00', 70.00, 'cancelled'),
(12, 14, '2025-01-18', '17:00:00', '18:00:00', 55.00, 'confirmed'),
(13, 15, '2025-01-19', '21:00:00', '22:00:00', 75.00, 'confirmed'),
(14, 17, '2025-01-21', '09:00:00', '10:00:00', 90.00, 'pending'),
(15, 18, '2025-01-22', '10:00:00', '11:00:00', 85.00, 'confirmed'),
(16, 19, '2025-01-15', '19:00:00', '20:00:00', 50.00, 'confirmed'),
...
(5, 5, '2025-01-17', '20:00:00', '21:00:00', 95.00, 'confirmed'),
(6, 9, '2025-01-21', '10:00:00', '13:00:00', 285.00, 'confirmed'),
(7, 10, '2025-01-22', '16:00:00', '19:00:00', 315.00, 'cancelled'),
(8, 6, '2025-01-18', '09:00:00', '12:00:00', 360.00, 'confirmed'),
(9, 16, '2025-01-20', '08:00:00', '09:00:00', 80.00, 'confirmed'),
(10, 11, '2025-01-16', '18:00:00', '19:00:00', 60.00, 'pending'),
(11, 12, '2025-01-17', '19:00:00', '20:00:00', 65.00, 'confirmed');
...
(9, 330.00, 'upi', 'completed', '2025-01-15'),
(10, 65.00, 'debit_card', 'completed', '2025-01-16'),
(12, 55.00, 'upi', 'completed', '2025-01-17'),
(13, 75.00, 'credit_card', 'completed', '2025-01-18'),
(15, 85.00, 'upi', 'completed', '2025-01-19'),
(16, 50.00, 'debit_card', 'completed', '2025-01-14'),
(17, 45.00, 'upi', 'completed', '2025-01-15'),
(18, 75.00, 'credit_card', 'completed', '2025-01-16'),
(20, 95.00, 'upi', 'completed', '2025-01-16'),
(21, 285.00, 'debit_card', 'completed', '2025-01-20'),
(23, 360.00, 'upi', 'completed', '2025-01-17'),
(24, 80.00, 'credit_card', 'completed', '2025-01-19'),
(26, 65.00, 'upi', 'completed', '2025-01-16'),
(3, 90.00, 'upi', 'pending', '2025-01-20'),
(8, 70.00, 'credit_card', 'pending', '2025-01-16');

-- 9. Feedback Data (20 feedback entries)
INSERT INTO feedback (user_id, venue_id, rating, comment, feedback_date) VALUES
...
(5, 2, 5, 'Amazing venue with top-notch maintenance.', '2025-01-16'),
(6, 7, 4, 'Decent cricket facilities, friendly staff.', '2025-01-20'),
(7, 11, 3, 'Basketball court is okay, needs better flooring.', '2025-01-16'),
(9, 8, 5, 'Outstanding cricket academy with professional coaches.', '2025-01-21'),
(10, 12, 4, 'Good sports complex, well-organized.', '2025-01-17'),
(12, 14, 4, 'Nice court, good for casual games.', '2025-01-19'),
(13, 15, 5, 'Excellent basketball facilities, highly recommended!', '2025-01-20'),
(15, 18, 4, 'Great tennis academy, good coaching staff.', '2025-01-23'),
(16, 19, 3, 'Badminton hall is decent, but ventilation could be better.', '2025-01-16'),
(2, 20, 4, 'Good shuttle arena, reasonable prices.', '2025-01-17'),
(3, 1, 5, 'Love playing here! Great atmosphere.', '2025-01-18'),
(6, 9, 4, 'Nice cricket ground, well-maintained pitch.', '2025-01-22'),
(8, 6, 5, 'Perfect venue for cricket matches!', '2025-01-19'),
(9, 16, 4, 'Good tennis courts, needs better net quality.', '2025-01-21'),
(11, 12, 3, 'Average facilities, could be improved.', '2025-01-18'),
(4, 16, 5, 'Excellent tennis facilities and coaching!', '2025-01-22'),
(14, 17, 4, 'Great tennis club with good amenities.', '2025-01-22'),
(5, 2, 5, 'Always a pleasure to play at this venue!', '2025-01-17');
...
(5, 'Match Reminder', 'Your match with Deccan Dynamos is scheduled for tomorrow.', 'match', TRUE, '2025-01-14 18:00:00'),
(6, 'Venue Update', 'Deccan Cricket Club has updated their facilities.', 'venue', FALSE, '2025-01-14 12:30:00'),
(7, 'Booking Confirmed', 'Your booking at Deccan Basketball Court confirmed.', 'booking', TRUE, '2025-01-14 19:20:00'),
(8, 'Team Captain Update', 'You are now the captain of Swargate Strikers.', 'team', FALSE, '2025-01-15 11:45:00'),
(9, 'Payment Reminder', 'Please complete payment for your Kharadi Cricket booking.', 'payment', FALSE, '2025-01-15 09:30:00'),
(10, 'New Venue Available', 'Kothrud Sports Complex is now available for booking.', 'venue', TRUE, '2025-01-16 14:15:00'),
(11, 'Match Result', 'Deccan Smashers won the badminton match 21-19.', 'match', TRUE, '2025-01-16 20:30:00'),
(12, 'Booking Cancelled', 'Your booking at Wakad Court has been cancelled.', 'booking', FALSE, '2025-01-17 08:45:00'),
(13, 'Team Practice', 'Team practice scheduled at Magarpatta Basketball tomorrow.', 'team', FALSE, '2025-01-17 16:20:00'),
(14, 'Payment Successful', 'Payment of ₹55 completed for Wakad Court booking.', 'payment', TRUE, '2025-01-17 19:10:00'),
(15, 'New Member Added', 'Welcome to Pune All-Stars! Your membership is now active.', 'team', FALSE, '2025-01-18 13:25:00'),
(16, 'Venue Feedback', 'Thank you for rating Swargate Badminton Hall.', 'feedback', TRUE, '2025-01-16 21:15:00'),
...
(5, 'Team Meeting', 'Team meeting scheduled for this Saturday at 6 PM.', 'team', FALSE, '2025-01-20 12:20:00'),
(6, 'Weather Alert', 'Rain expected tomorrow, outdoor bookings may be affected.', 'weather', TRUE, '2025-01-21 07:30:00'),
(7, 'New Coach Available', 'Professional basketball coach now available for training.', 'coaching', FALSE, '2025-01-21 14:50:00'),
(8, 'Maintenance Notice', 'Kothrud Football Ground will be under maintenance on Jan 25.', 'maintenance', FALSE, '2025-01-22 09:15:00'),
(9, 'Achievement Unlock', 'Congratulations! You have played 10 matches this month.', 'achievement', TRUE, '2025-01-22 17:40:00'),
(10, 'Booking Confirmation', 'Your regular slot at Deccan Basketball Court is confirmed.', 'booking', FALSE, '2025-01-22 20:25:00'),
(11, 'Team Update', 'Deccan Smashers practice venue changed to Kothrud Shuttle Arena.', 'team', FALSE, '2025-01-23 11:30:00');
